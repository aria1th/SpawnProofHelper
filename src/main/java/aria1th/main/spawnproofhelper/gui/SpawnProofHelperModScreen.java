package aria1th.main.spawnproofhelper.gui;
...
public class SpawnProofHelperModScreen extends Screen {

    private OptionListWidget list;
    private final Configs configs;
    private final Screen parent;

    public SpawnProofHelperModScreen(Screen parent) {
        super(new LiteralText("SpawnProofHelperModScreen Options"));
    ...
    public void init() {
        ...
        this.addDrawableChild(new ButtonWidget(this.width / 2 - 155, this.height - 29, 150, 20, Text.of("Reset Config"), (buttonWidget) -> {
            ...
            this.client.setScreen(new SpawnProofHelperModScreen(this));
        }));
    }
